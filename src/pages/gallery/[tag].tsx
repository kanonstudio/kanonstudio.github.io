...
export const ArtworkByTagPageLayout = ({
  title,
  children,
}: {
  title: string;
...
export const CategoryBreadCrumb = ({ category }: { category: string }) => {
  return (
    <section>
      {/* breadcrumbs */}
...
const ArtworkByTagPage = ({
  ...
  return (
    <ArtworkByTagPageLayout title={`Category: ${category}`}>
    ...
    </ArtworkByTagPageLayout>
  );
};
export default ArtworkByTagPage;
